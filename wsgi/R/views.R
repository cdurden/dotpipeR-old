...
setGeneric(name="view",def=function(x,tmpdir,...) standardGeneric("view"))
...
#
#setMethod("view",
#    signature(x = "data.frame", method = "character", tmpdir = "ANY"),
#    function (x, method=c("default"),tmpdir=tempdir(),...)
#    {
#    }
#)
#
#setMethod("view",
#    signature(x = "richest", method = "character", tmpdir = "ANY"),
#    function (x, method=c("default"),tmpdir=tempdir(),...)
#    {
#        if(method=="default") {
#            graphics_data <- png(tempfile(tmpdir=tmpdir),...)
