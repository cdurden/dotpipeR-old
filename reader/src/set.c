...
return list_insert(set, list_tail(set), data);
...
for (member = list_head(set1); member != NULL; member = list_next(member)) {
   ...
   if (list_insert(setu, list_tail(setu), data) != 0) {
...
for (member = list_head(set1); member != NULL; member = list_next(member)) {
   ...
   if (set_is_member(set2, list_data(member))) {
      ...
      if (list_insert(seti, list_tail(seti), data) != 0) {
...
for (member = list_head(set1); member != NULL; member = list_next(member)) {
   ...
   if (!set_is_member(set2, list_data(member))) {
      ...
      if (list_insert(setd, list_tail(setd), data) != 0) {
