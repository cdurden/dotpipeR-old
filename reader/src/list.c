...
while (list_size(list) > 0) { 
   ...
   if (list_remove(list, NULL, (void **)&data) == 0 && list->destroy != 
      NULL) { 
...
int list_insert(List *list, ListElmt *element, const void *data) { 
 
ListElmt           *new_element; 
 
//printf("list_insert: 0x%x\n", (int) data); 
/***************************************************************************** 
*                                                                            * 
...
int list_index (List *list, ListElmt **index) {
    int i = 0;
    ListElmt *element;
...
int list_which (List *list, void *data) {
    int i = 0;
    ListElmt *element;
    for (element = list_head(list); element != NULL; element = list_next(element)) {
